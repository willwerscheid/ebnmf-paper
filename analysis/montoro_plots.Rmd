...
factor_colors <-
  c(k1 = "black",k2 = "black",k3 = "black",k4 = "black",k5 = "black",
    k6 = "black",k7 = "black",k8 = "black",k9 = "black",k10 = "black",
    k11 = "black",k12 = "black",k13 = "black",k14 = "black",k15 = "black",
    k16 = "black",k17 = "black",k18 = "black",k19 = "black",k20 = "black",
    k21 = "black",k22 = "black",k23 = "black",k24 = "black",k25 = "black",
    k26 = "black",k27 = "black",k28 = "black",k29 = "black",k30 = "black",
    k31 = "black",k32 = "black",k33 = "black",k34 = "black",k35 = "black",
    k36 = "black",k37 = "black",k38 = "black",k39 = "black",k40 = "black")
...
TO DO: Create the structure plots for the k=40 fit.

```{r structure-plots-k40, fig.height=5.5, fig.width=7.5, message=FALSE, results="hide"}
set.seed(1)
celltype_factors <- c(2,3,4,5,6,7,10,12,13,16,17,19,20,21,25,34,37)
...
rows <- c(sample(which(celltypes == "Basal"),5000),
          sample(which(celltypes == "Club"),4000),
          which(celltypes != "Basal" & celltypes != "Club"))
rows <- sort(rows)
F <- F[rows,]
celltypes <- celltypes[rows]
...
```{r, eval=FALSE}
round(sort(drop(cor(F,celltypes == "Ionocyte"))),digits = 4)
round(sort(drop(cor(F,meta_data[rows,"mouse"] == "R3"))),digits = 4)
round(sort(drop(cor(F,meta_data[rows,"lineage"] == "Tom"))),digits = 4)
pdat <- cbind(F,meta_data[rows,])
p1 <- ggplot(pdat,aes(x = mouse,y = k27)) +
