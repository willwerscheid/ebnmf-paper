...
factor_colors <-
  c(k1 = "black",k2 = "darkblue",k3 = "forestgreen",k4 = "blue",
    ...
    k9 = "cornflowerblue",k10 = "darkmagenta",k11 = "black",k12 = "darkorange",
    k13 = "black",k14 = "black",k15 = "dodgerblue",k16 = "limegreen",
    k17 = "royalblue",k18 = "salmon",k19 = "gold",k20 = "sienna",
    k21 = "darkmagenta",k22 = "peru",k23 = "black",k24 = "magenta",
...
```{r structure-plots-k30, fig.height=5.5, fig.width=7.5, message=FALSE, results="hide"}
set.seed(1)
celltype_factors <- c(6,10,16,9,2,4,3,22,20,18,5,24,17,15,19,12)
celltype_factors_old <- c(7,19,2,3,4,5,21,17,16,13,6,12,10,25,20)
...
```{r another-structure-plot-k30, fig.height=2.75, fig.width=7.5, message=FALSE, results="hide"}
...
F <- F[rows,]
celltypes <- celltypes[rows]
round(sort(drop(cor(celltypes == "Club (hillock)",F))),digits = 3)
```
