...
```{r structure-plots-k30, fig.height=5.5, fig.width=7.5, message=FALSE, results="hide", eval=FALSE}
set.seed(1)
...
```{r another-structure-plot-k40, fig.height=2.75, fig.width=7.5, message=FALSE, results="hide", eval=FALSE}
