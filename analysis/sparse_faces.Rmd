...
For a better comparison, let's plot the parts again next to each
other. In this figure, the second flashier run is in every second row
from the top:

```{r plot-parts-3, fig.height=5.5, fig.width=3.5}
