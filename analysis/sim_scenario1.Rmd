...
It will suffice to illustrate results for NMF, EBNMFnmf0, EBNMFalt0, and EBNMFalt2. We'll consider the setting where `shape = 2,` with the size of the rarest population equal to 10.
