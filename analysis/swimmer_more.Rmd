...
Let's see if we can improve the factorization further by adapting the
priors. Unfortunately, random initialization with an adaptive prior
does not work well at all, and I'm not sure why:
